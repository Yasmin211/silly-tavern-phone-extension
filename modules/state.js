...
export const PhoneSim_State = {
    ...
    worldDate: new Date(),
    worldTime: '12:00',
    customization: { isMuted: false, playerNickname: 'Me', enabled: true },
    ...
    loadCustomization: function() {
        try {
            ...
            const defaultCustomization = { isMuted: false, playerNickname: 'Me', enabled: true };
            ...
            this.customization = { isMuted: false, playerNickname: 'Me', enabled: true };
        }
    },
